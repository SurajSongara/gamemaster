...
const foodSound = new Audio('http://127.0.0.1:8000/static/music/food.mp3');
const gameOverSound = new Audio('http://127.0.0.1:8000/static/music/gameover.mp3');
const moveSound = new Audio('http://127.0.0.1:8000/static/music/move.mp3');
const musicSound = new Audio('http://127.0.0.1:8000/static/music/music.mp3');
let speed = 3;
let score = 0;
let lastPaintTime = 0;
let snakeArr = [
